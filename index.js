...
const enableAnalytics = () => {
  const analyticsMod = goosemodScope.webpackModules.findByProps('analyticsTrackingStoreMaker');

  analyticsMod.AnalyticsActionHandlers.handleTrack = originals.analytics;
};

const disableAnalytics = () => {
  const analyticsMod = goosemodScope.webpackModules.findByProps('analyticsTrackingStoreMaker');

  originals.analytics = analyticsMod.AnalyticsActionHandlers.handleTrack;
  analyticsMod.AnalyticsActionHandlers.handleTrack = () => {};
};
